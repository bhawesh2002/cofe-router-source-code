 ...
 //           var attachedDevices = data.lan_station_list || data.station_list;
    ...
    function getLanInfo() {
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.cmd = "lan_ipaddr,lan_netmask,mac_address,dhcpEnabled,dhcpStart,dhcpEnd,dhcpLease_hour,login_mode";
            requestParams.multi_data = 1;
            return requestParams;
        }
	...
	function getTelnetAdb (){
        ...
        function deal(data) {
			return {
				...
				adbMode : data.adbd_enable,
				twtoolmode : data.twtool_enable,
				twlogmode : data.tw_log_mode, 
			}
        }
    }
    ...
    function getlockbandinfo (params, callback){
        ...
        function prepare(params, isPost) {
            return {
                isTest:isTest,
                multi_data:1,
                cmd:"LteBandLockSet,LteBandLockState,band_1,band_2,band_3,band_4,band_5,band_7,band_8,band_17,band_20,band_28,"+
                ...
                "amt_band_28,amt_band_34,amt_band_38,amt_band_39,amt_band_40,amt_band_41"
            };
        }
        function deal(data) {
            if (data) {
    ...
    function getlockcellinfo (params, callback){
        ...
        function prepare(params, isPost) {
            return {
                isTest:isTest,
                multi_data:1,
                cmd:"nv_arfcn,nv_pci,CellLockSet,CellLockState,actionlte,uarfcnlte,cellParaIdlte,sub_network_type,network_type", 	
          };
        }
        function deal(data) {
            if (data) {
    ...
    function getNetworkStatue(params, callback){
        ...
        function prepare(params, isPost) {
            return {
                isTest:isTest,
                multi_data:1,
                cmd:"network_provider,network_type,sub_network_type,ModemStatue,ppp_status,nv_band,nv_bandwidth,nv_arfcn,nv_globecellid,nv_enodbid,nv_cellid,nv_pci,nv_rsrp,nv_rsrq,"+
				"nv_sinr,nv_rsrq,creg_stat,cereg_stat,nv_sinr"
            };
        }
        function deal(data) {
            if (data) {
